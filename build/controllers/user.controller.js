...
var sendOTPController = exports.sendOTPController = /*#__PURE__*/function () {
  var _ref4 = (0, _asyncToGenerator2["default"])(/*#__PURE__*/_regenerator["default"].mark(function _callee4(req, res) {
    var _req$body2, mobileNumber, otp, _yield$sendOTPService, _otp, userMobileNumber;
    return _regenerator["default"].wrap(function _callee4$(_context4) {
      while (1) switch (_context4.prev = _context4.next) {
        case 0:
          _req$body2 = req.body, mobileNumber = _req$body2.mobileNumber, otp = _req$body2.otp;
          _context4.prev = 1;
          _context4.next = 4;
          return (0, _user.sendOTP)(mobileNumber);
        case 4:
          _yield$sendOTPService = _context4.sent;
          _otp = _yield$sendOTPService.otp;
          userMobileNumber = _yield$sendOTPService.mobileNumber;
          res.status(200).json({
            message: 'OTP sent successfully',
            mobileNumber: userMobileNumber,
            otp: _otp
          }); //  IMPORTANT:  Do NOT send the OTP back in the response in a real application
          _context4.next = 13;
          break;
        case 10:
          _context4.prev = 10;
...
var resendOTPController = exports.resendOTPController = /*#__PURE__*/function () {
  var _ref5 = (0, _asyncToGenerator2["default"])(/*#__PURE__*/_regenerator["default"].mark(function _callee5(req, res) {
    var mobileNumber, _yield$sendOTPService2, otp, userMobileNumber;
    return _regenerator["default"].wrap(function _callee5$(_context5) {
      while (1) switch (_context5.prev = _context5.next) {
        case 0:
          ...
          return (0, _user.sendOTP)(mobileNumber);
        case 4:
          _yield$sendOTPService2 = _context5.sent;
          otp = _yield$sendOTPService2.otp;
          userMobileNumber = _yield$sendOTPService2.mobileNumber;
          res.status(200).json({
