...
var _require = require('./email.service'),
...
//   return { mobileNumber, emailSent: !!email };
    ...
    return _regenerator["default"].wrap(function _callee4$(_context4) {
      while (1) switch (_context4.prev = _context4.next) {
        ...
        case 3:
          ...
          _context4.next = 9;
          return sendVerificationEmail(user.email, otp);
        case 9:
          console.log("\uD83D\uDCE9 OTP sent to email ".concat(user.email, " (linked with mobile ").concat(mobileNumber, ")"));
