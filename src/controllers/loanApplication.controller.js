import {
  ...
  updateLoanApplicationStatus as updateLoanApplicationStatusService
...
export const updateLoanApplicationStatus = async (req, res) => {
  try {
   ...
   const updatedApplication = await  updateLoanApplicationStatusService(loanId, status, req.user.role, req.user._id);
